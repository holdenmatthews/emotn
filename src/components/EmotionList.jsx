...
const EmotionList = (props) => {
  ...
  return (
    <div className='shadow-xl flex flex-col items-center mt-64 p-2 bg-green-800 bg-opacity-10 rounded'>
      <h3 className='text-green-950 m-2 mx-4'>Click an emotion below to add it to your log!</h3>
